...
def print_vals(model, train_rmsle, test_rmsle, validate_rmsle):
    string = 'Model: {}\nTrain: {}\nTest: {}\nValidate: {}'.format(
        model, train_rmsle, test_rmsle, validate_rmsle)
    print(string)
...
def regressor_procedure(ml_model, comp_data, model_desc):
    ...
    print_vals(model_desc, train_rmsle, test_rmsle, validate_rmsle)
    return ml_model
